    ...
    <div className="flex h-full min-h-0 flex-col flex-1">
      <div className="relative min-h-0 flex-1">
        <Textarea
          ...
          className="absolute inset-0 resize-none border-0 bg-transparent p-4 pb-6 lg:pb-8 lg:p-6 text-base! leading-relaxed tracking-tight shadow-none wrap-break-word focus-visible:ring-0"
